...
const Explanation = ({ content } : { content : PropsProps[]}) => {
  return (
    <div className='flex dark:border-zinc-800 border-zinc-200 border h-[300px] flex-col w-[80%] overflow-scroll'>
            ...
            content.map((prop, index) => {
                return (
                    <div key={index} className='w-full h-full border-b dark:border-b-zinc-800 border-b-zinc-200 flex justify-between items-center'>
                        <div className='w-full font-sans font-light h-full flex text-center justify-center items-center py-3'>{prop.propName}</div>
                        <Separator orientation='vertical' className='' />
                        <div className='w-full font-sans font-light h-full flex text-center justify-center items-center py-3'>{prop.type}</div>
                        <Separator orientation='vertical' className='' />
                        <div className='w-full font-sans font-light h-full flex text-center justify-center items-center py-3'>{prop.default}</div>
                        <Separator orientation='vertical' className='' />
                        <div className='w-full font-sans font-light h-full flex text-center justify-center items-center py-3'>{prop.description}</div>
                    </div>
                )
            })
        }
